...
SaveTheMinions.MainMenu.prototype = {
	...
	// A button made from an image including text
	howToButton = this.add.button(320, 300, 'howToBtn', function(){this.game.state.start('StoryHowto')}, this, 1, 0, 2);
	howToButton.anchor.setTo(0.5,0.5);

	// A button made from an image to select levels

	howToButton = this.add.button(320, 400, 'levelBtn', function(){this.game.state.start('LevelSelect')}, this, 1, 0, 2);
	howToButton.anchor.setTo(0.5,0.5);
