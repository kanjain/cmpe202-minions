...
SaveTheMinions.Game.prototype = {
    ...
    spawnMinion: function() {
            ...
            this.minion = minionFactoryObj.createMinions(this.game, rand).minion;
            ...
            this.minion.events.onInputDown.add(this.selectt, this.minion);
            this.minion.anchor.setTo(0.5, 0.5);
            this.minion.rotateMe = (Math.random()*8)-4;
            flyingMinions.add(this.minion);
            totalMinions++;
